...
<head>
    ...
    <title><?php echo htmlspecialchars($blog['title']); ?> - Eventra</title>
    <link rel="stylesheet" href="assets/css/style.css">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">
</head>
<body>
    <!-- Navbar with Blog active -->
    <nav class="navbar">
    ...
    <div class="blog-detail">
        <img src="assets/images/<?php echo htmlspecialchars($blog['image'] ?? 'default.jpg'); ?>" alt="<?php echo htmlspecialchars($blog['title']); ?>">
        <div class="blog-meta" style="text-align: center; margin-bottom: 2rem;">
